...
export default class Header extends React.Component<{}, {}> {
        ...
        return (
            <Navbar fixed="top" bg="primary" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="mr-auto">
                        <NavDropdown title={appStore.isAuthorize ? appStore.getValue('userName') : 'Profile'} id="basic-nav-dropdown">
                            {!appStore.isAuthorize && <React.Fragment>
                                <Form>
                                    <Form.Group>
                                ...
                                <NavDropdown.Divider />
                                <NavDropdown.Item>
                                    <div style={{textAlign: 'center'}}><Button type="button" onClick={this.onSignIn}>Sign in</Button></div>
                                </NavDropdown.Item>
                                <NavDropdown.Divider />
                                <NavDropdown.Item>
    ...
    onSignIn = () => {
        ...
        ApiService.postData(ApiUrls.SignInUrl, login).then((response: TokenModel) => {
